...
type UserServiceClient interface {
	...
	DeleteUserByID(ctx context.Context, in *UserIDRequest, opts ...grpc.CallOption) (*UserDeleteResponse, error)
}
...
func (c *userServiceClient) DeleteUserByID(ctx context.Context, in *UserIDRequest, opts ...grpc.CallOption) (*UserDeleteResponse, error) {
	out := new(UserDeleteResponse)
	err := c.cc.Invoke(ctx, "/UserService/DeleteUserByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	DeleteUserByID(context.Context, *UserIDRequest) (*UserDeleteResponse, error)
...
func (UnimplementedUserServiceServer) DeleteUserByID(context.Context, *UserIDRequest) (*UserDeleteResponse, error) {
...
func _UserService_DeleteUserByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/UserService/DeleteUserByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
